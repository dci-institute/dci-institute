...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => DailyReportFormWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => HomeworkAssignmentWidget(),
        ),
        FFRoute(
          name: AnnouncementsFeedWidget.routeName,
          path: AnnouncementsFeedWidget.routePath,
          builder: (context, params) => AnnouncementsFeedWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => AboutDCIWidget(),
        )
